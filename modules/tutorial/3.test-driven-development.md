...
public void EnterCommand_WhenNumberGreaterThan999_ShouldThrowError()
{
	...
	Assert.Throws<IMachineException>(() => machine.EnterCommand("1000"));
}
...
Bom, agora iremos fazer o nosso projeto compilar, ele ainda não irá funcionar, porém poderemos rodar os testes (e todos obviamente irão falhar).
